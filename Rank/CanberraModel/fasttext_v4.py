...
pickle_root = '/ANU/Sem4/COMP8715/project/NewsAggregatorSem2/Rank/CanberraModel/Output/text_1200.p'
# nlp = spacy.load('en_core_web_lg')
headlines = pickle.load(open(pickle_root, "rb" ))
train_dir = '/ANU/Sem4/COMP8715/project/NewsAggregatorSem2/Rank/CanberraModel/Output/Data/train.txt'
test_dir = '/ANU/Sem4/COMP8715/project/NewsAggregatorSem2/Rank/CanberraModel/Output/Data/test.txt'
result_dir = '/ANU/Sem4/COMP8715/project/NewsAggregatorSem2/Rank/CanberraModel/Output/Results'
model_dir = '/ANU/Sem4/COMP8715/project/NewsAggregatorSem2/Rank/CanberraModel/Output/text_1200'
read_model_dir = '/ANU/Sem4/COMP8715/project/NewsAggregatorSem2/Rank/CanberraModel/Output/text_1200.bin'
...
def generate_result(test_dir,classifier):# use fasttext to predict the mails into spam or ham
    ...
    plt.savefig(result_dir+"/AUC_kosmos3.jpg")
    plt.show()
    ...
    plt.savefig(result_dir + "/Confusion Matrix_kosmos3.jpg")
    plt.show()
